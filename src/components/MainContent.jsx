        ...
        isModalVisible ? <Modal isSuccess={isSuccess} /> :
            !isMobile ? <div className={c.main}>
                ...
                <div className={c.main}>
                    ...
                    {pageMobile === 1 && <div className={c.buttCont}><div className={c.buttBackINVIS}>Назад</div><button className={ageUnderEi || errors?.firstName || errors?.secondName || errors?.day || errors?.month || errors?.year || !isValideDate || watch('firstName') === '' || watch('secondName') === '' || watch('day') === '' || watch('month') === '' || watch('year') === '' ? c.btnGrad + ' ' + c.btnGradOFF : c.btnGrad} onClick={() => { if (ageUnderEi || errors?.firstName || errors?.secondName || errors?.day || errors?.month || errors?.year || !isValideDate || watch('firstName') === '' || watch('secondName') === '' || watch('day') === '' || watch('month') === '' || watch('year') === '') { return } else { setPageMobile(2) } }}>Далі</button></div>}{/*onClick={mobileOnClick}*/}
                    {pageMobile === 2 && <div className={c.buttContReg}>
                        <div className={c.buttCont}><div className={c.buttBack} onClick={() => setPageMobile(1)}>Назад</div><button className={!canClick || ageUnderEi || errors?.firstName || errors?.secondName || errors?.day || errors?.month || errors?.year || errors?.phone || errors?.card || !isValideDate || watch('firstName') === '' || watch('secondName') === '' || watch('day') === '' || watch('month') === '' || watch('year') === '' || phone === '' || errorCard ? c.btnGrad + ' ' + c.btnGradOFF : c.btnGrad} onClick={() => { if (!canClick || ageUnderEi || errors?.firstName || errors?.secondName || errors?.day || errors?.month || errors?.year || errors?.phone || errors?.card || !isValideDate || watch('firstName') === '' || watch('secondName') === '' || watch('day') === '' || watch('month') === '' || watch('year') === '' || phone === '' || errorCard) { return } else { setPageMobile(3) } }}>Далі</button></div> {/*onClick={validCont}*/}
                        <div></div>
                    </div>}
                    {pageMobile === 3 && <div className={c.buttContReg}>
                        <div className={c.buttCont}><div className={c.buttBack} onClick={() => setPageMobile(2)}>Назад</div><button className={errors?.email || errors?.password || password !== passwordCheck || watch('password') === '' || watch('email') === '' ? c.btnGrad + ' ' + c.btnGradOFF : c.btnGrad} onClick={errors?.email || errors?.password || password !== passwordCheck || watch('password') === '' || watch('email') === '' ? null : () => setPageMobile(4)}>Далі</button></div>{/*onClick={errors?.email || errors?.password || password !== passwordCheck || watch('password') === '' || watch('email') === '' ? null : toFourthFunc}*/}
                        <div></div>
                    </div>}
